...
param public_domain string = 'demo.be'
param internal_domain string = 'demo.internal'
param apigw_external_hostname string = 'api.${public_domain}'
param portal_external_hostname string = 'portal.${public_domain}'
param mgmt_external_hostname string = 'mgmt.${public_domain}'
param apigw_backend_hostname string = 'api.${internal_domain}'
param portal_backend_hostname string = 'portal.${internal_domain}'
param mgmt_backend_hostname string = 'mgmt.${internal_domain}'
param keyvault_gw_cert string = 'gwapicert'
